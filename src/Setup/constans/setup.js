...
export const defaultWordGroupContent = 'The Quiz start group. If the group is not chosen or default group is chosen - quiz will be started from random group';
